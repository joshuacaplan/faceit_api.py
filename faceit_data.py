...
class FaceitData:
    ...
    def championship_details(self, championship_id=None, expanded=None):
        ...
        if championship_id is None:
            ...
            if expanded is not None:
                if expanded.lower() is "game":
                    api_url += "?expanded=game"
                elif expanded.lower() is "organizer":
    ...
    def player_matches(self, player_id=None, game=None, from_timestamp=None, to_timestamp=None, starting_item_position=0, return_items=20):
    ...
    def tournament_details(self, tournament_id=None, expanded=None):
        ...
        if tournament_id is None:
            ...
            if expanded is not None:
                if expanded.lower() is "organizer":
                    api_url += "?expanded=organizer"
                elif expanded.lower() is "game":
                    api_url += "?expanded=game"
